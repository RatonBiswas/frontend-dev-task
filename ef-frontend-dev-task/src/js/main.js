...
dropdownEl.forEach((dropdown) => {
  ...
  anchor.addEventListener("click", (e) => {
    ...
    isDropdownActive && (e.target.style.opacity = "");
    ...
    dropdownEl.forEach((siblingDropdown) => {
      ...
      siblingDropdown !== dropdown &&
        ...
        isDropdownActive && (siblingAnchor.style.opacity = 0.5));
    });
  });
});
...
const searchOpenElDesktop = document.querySelector(
  '[data-target="search-open-desktop"]',
);
...
const searchOpenElMobile = document.querySelector(
